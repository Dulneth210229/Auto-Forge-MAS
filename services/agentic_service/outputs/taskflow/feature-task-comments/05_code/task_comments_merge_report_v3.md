...
- **page reachability**: failed
  ```
  These pages have no way to reach them by clicking from "/":
  - /tasks/:taskId
  ```
- **home page render**: failed
  ```
  Failed to load /: It looks like you are using Playwright Sync API inside the asyncio loop.
  Please use the Async API instead.
  ```
- **feature page render**: info
  ```
  No reachable feature pages to check.
  ```
