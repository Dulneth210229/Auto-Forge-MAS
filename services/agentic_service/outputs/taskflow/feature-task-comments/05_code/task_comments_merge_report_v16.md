...
- **feature page render**: info
  ```
  1 of 2 feature page(s) had rendering issues (does not fail verification, review before approving):
  - /tasks: /tasks rendered with no JS errors and non-empty content.
  - /tasks/:taskId: /tasks/:taskId rendered with JS errors: ['Error fetching comments: SyntaxError: Unexpected token \'<\', "<!doctype "... is not valid JSON', 'Error loading comments: SyntaxError: Unexpected token \'<\', "<!doctype "... is not valid JSON']
  ```
...
+      "integrity": "sha512-1rYdTpyv03iycF1+BhzrzQJCdOu
```