...
- **FR-DOM-001** **[DOMAIN ADDED]**: The system must lock a user account temporarily after five consecutive failed login attempts. — Priority: Should Have
...
- **AC-003** **[DOMAIN ENHANCED]**: When the user clicks the 'Forgot Password' link, they must be directed to the password recovery initiation page, where a time-limited reset token (valid for 30-60 minutes) is generated and sent to the user's verified email address.
...
Added a requirement for account lockout after failed login attempts based on domain knowledge. Enhanced the 'Forgot Password' acceptance criterion to include token expiry and invalidation behavior.

**Knowledge sources used:**
- user_account_and_authentication.txt (2 chunk(s) used)

**Additions:**
- **FR-DOM-001** (functional_requirements): The system must lock a user account temporarily after five consecutive failed login attempts.
...
- **AC-003** (acceptance_criteria)
  ...
  - *After:* When the user clicks the 'Forgot Password' link, they must be directed to the password recovery initiation page, where a time-limited reset token (valid for 30-60 minutes) is generated and sent to the user's verified email address.
  - *Rationale:* This ensures secure and controlled password recovery by incorporating token expiry and verification practices from domain standards.
