...
- **database fallback quality scan**: info
  ...
  - app/api/item-listing-crud/route.ts:89: { status: 503 }
  - app/api/item-listing-crud/route.ts:100: { status: 400 }
  - app/api/item-listing-crud/route.ts:107: { status: 400 }
  - app/api/item-listing-crud/route.ts:114: { status: 400 }
  - app/api/item-listing-crud/route.ts:121: { status: 400 }
  - app/api/item-listing-crud/route.ts:128: { status: 400 }
  - app/api/item-listing-crud/route.ts:135: { status: 400 }
  - app/api/item-listing-crud/route.ts:154: { status: 500 }
  ```
- **request relevance scan**: info
  ```
  12/16 distinctive request word(s) found in the touched files.
  ```
