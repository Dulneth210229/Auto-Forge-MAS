...
- **planned files touched**: failed
  ```
  This attempt wrote or modified frontend code (under app/ or components/) but never called read_ui_component_design or read_ui_page_design, even though an approved UI/UX design exists for this feature. Call list_unread_ui_designs, then read the design(s) relevant to the page/component you are writing, and make your TSX faithfully match its layout, Tailwind classes, and content before continuing.
...
+];
 // SEED_DATA_END
diff --git a/models/ItemListingCRUDDataEntity1.ts b/models/ItemListingCRUDDataEntity1.ts
new file mode 100644
index 0000000..171d61a
--- /dev/null
+++ b/models/ItemListingCRUDDataEntity1.ts
@@ -0,0 +1,7 @@
...
+});
+
+export default mongoose.models.ItemListingCRUDDataEntity1 || mongoose.model("ItemListingCRUDDataEntity1", schema);
\ No newline at end of file
diff --git a/models/ItemListingCRUDDataEntity2.ts b/models/ItemListingCRUDDataEntity2.ts
new file mode 100644
index 0000000..843804b
--- /dev/null
+++ b/models/ItemListingCRUDDataEntity2.ts
@@ -0,0 +1,7 @@
+import mongoose, { Schema } from "mongoose";
+
+const schema = new Schema({
...
+});
+
+export default mongoose.models.ItemListingCRUDDataEntity2 || mongoose.model("ItemListingCRUDDataEntity2", schema);
\ No newline at end of file
diff --git a/models/ItemListingCRUDDataEntity3.ts b/models/ItemListingCRUDDataEntity3.ts
new file mode 100644
index 0000000..a0e793f
--- /dev/null
+++ b/models/ItemListingCRUDDataEntity3.ts
@@ -0,0 +1,7 @@
+import mongoose, { Schema } from "mongoose";
+
+const schema = new Schema({
...
+});
+
+export default mongoose.models.ItemListingCRUDDataEntity3 || mongoose.model("ItemListingCRUDDataEntity3", schema);
\ No newline at end of file
diff --git a/models/ItemListingCRUDDataEntity4.ts b/models/ItemListingCRUDDataEntity4.ts
new file mode 100644
index 000
```