...
- **request relevance scan**: info
  ```
  9/11 distinctive request word(s) found in the touched files.
  ```
...
+          />
+          <p className="mt-2 text-sm text-gray-500">Notes are saved automatically.</p>
+        </div>
+        
+        <div>
+          <ItemNotesList 
