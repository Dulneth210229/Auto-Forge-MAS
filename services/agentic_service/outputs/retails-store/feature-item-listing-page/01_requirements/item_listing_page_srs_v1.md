...
- **FR-001** → Acceptance Criteria: AC-005
  - Notes: Pagination is part of viewing items
- **FR-002** → Acceptance Criteria: AC-001
  - Notes: Search matches name or description
- **FR-003** → Acceptance Criteria: AC-002, AC-003, AC-004
  - Notes: Filtering by category, price, and availability
- **FR-004** → Acceptance Criteria: AC-006
  - Notes: Sorting by price low-to-high
- **FR-005** → Acceptance Criteria: N/A
  - Notes: Clicking item navigates to detail page
- **FR-006** → Acceptance Criteria: AC-005
  - Notes: Changing items per page affects pagination
- **FR-007** → Acceptance Criteria: N/A
  - Notes: Add to cart or wishlist from listing page
- **FR-008** → Acceptance Criteria: N/A
  - Notes: Admin can mark items as featured
